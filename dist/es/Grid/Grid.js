...
var Grid = function (_React$PureComponent) {
  ...
  _createClass(Grid, [{
    ...
    value: function getDerivedStateFromProps(nextProps, prevState) {
      ...
      } else if (nextProps.scrollLeft !== instanceProps.prevScrollLeft
         && nextProps.scrollToColumn < 0 || nextProps.scrollTop !== instanceProps.prevScrollTop && nextProps.scrollToRow < 0) {
